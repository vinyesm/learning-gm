...
% varFenchel computes gradients used for Fenchel duality gap computation
% fid is the function id
%           f(M)=0.5*|X*M*X-Y|_F^2 (1)
%           grad1 is the gradient of 0.5*|.|_F^2 evaluated at X*M*X-Y
%           grad2 is the gradient of f evaluated at M
%           the simple relation between the two is grad2=X*grad1*X
debug=0;
grad1=0;
grad2=0;
