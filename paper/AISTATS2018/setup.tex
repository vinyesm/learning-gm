...
%\begin{algorithmic}[1]
%\State\textbf{Require: } $f$ quadratic, tolerance $\epsilon$ 
%\State\textbf{Initialization: } $L^{0}=L_{0}$, $\mathcal{A}^{0}_{\Omega}=\mathcal{A}_{0}$, $t=0$
%\While{c=\texttt{true}}
