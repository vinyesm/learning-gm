...
\hfill
\center
\subfigure[\textit{Model 1}]{\includegraphics[width=8cm]{fig/disjoint_graph}}
\hfill
\center
\subfigure[\textit{Model 1}]{\includegraphics[width=8cm]{fig/diff_graph}}
\hfill
\subfigure[\textit{Model 1}]{\includegraphics[width=8cm]{fig/over_graph}}
