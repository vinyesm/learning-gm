...
addpath DREAM5_NetworkInferenceChallenge_AlternativeDataFormats/net3/
...
%E. coli
CCC=importdata('DREAM5_NetworkInference_Community_Network3.txt');

BBB=importdata('net3_expression_data_avg_t.tsv','\t');
