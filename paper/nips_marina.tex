...
\begin{abstract}
Learnin GGM with latent variables with effect of latent variables. Recover the structure of the complete model\\
Introduce a norm psd, sum of low rank sparse components\\
Propose a tractable convex algorithm \\
Study identifiability conditions\\
\end{abstract}
